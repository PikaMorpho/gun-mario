...
sprites.onOverlap(SpriteKind.MickeyBullet, SpriteKind.Bob_omb, function (sprite, otherSprite) {
    if (Bobomb_Anger < 5) {
        info.changeScoreBy(1)
        Bobomb_Anger += 1
        scene.cameraShake(4, 500)
...
sprites.onOverlap(SpriteKind.MickeyBullet, SpriteKind.Enemy, function (sprite, otherSprite) {
    otherSprite.destroy(effects.fire, 2000)
    info.changeScoreBy(1)
    otherSprite.setVelocity(0, 50)
    otherSprite.setBounceOnWall(false)
...
sprites.onOverlap(SpriteKind.luigi_bullet, SpriteKind.blue_koopa, function (sprite, otherSprite) {
    sprite.destroy(effects.fire, 2000)
...
sprites.onOverlap(SpriteKind.luigi_bullet, SpriteKind.ParagoombaProjectile, function (sprite, otherSprite) {
    otherSprite.destroy(effects.fire, 2000)
    info.changeScoreBy(1)
    otherSprite.setVelocity(0, 50)
    otherSprite.setBounceOnWall(false)
...
sprites.onOverlap(SpriteKind.luigi_bullet, SpriteKind.Enemy3, function (sprite, otherSprite) {
    if (Timer >= 5) {
        info.changeScoreBy(1)
        Paragoomba_Health2 += -1
        scene.cameraShake(4, 500)
...
sprites.onOverlap(SpriteKind.MickeyBullet, SpriteKind.Enemy2, function (sprite, otherSprite) {
    if (Timer >= 5) {
        info.changeScoreBy(1)
        Paragoomba_Health += -1
        scene.cameraShake(4, 500)
...
sprites.onOverlap(SpriteKind.luigi_bullet, SpriteKind.Enemy2, function (sprite, otherSprite) {
    if (Timer >= 5) {
        info.changeScoreBy(1)
        Paragoomba_Health += -1
        scene.cameraShake(4, 500)
...
sprites.onOverlap(SpriteKind.MickeyBullet, SpriteKind.Enemy3, function (sprite, otherSprite) {
    if (Timer >= 5) {
        info.changeScoreBy(1)
        Paragoomba_Health += -1
        scene.cameraShake(4, 500)
...
let luigi_bullet_4: Sprite = null
let luigi_bullet_3: Sprite = null
let luigi_bullet_2: Sprite = null
let luigi_bullet_1: Sprite = null
let luigi_bullet: Sprite = null
...
forever(function () {
    pauseUntil(() => Anger_Fuse <= 0)
    if (Bobomb_Anger == 5) {
        Fuse = 0
        Bobomb.setKind(SpriteKind.Invulnerable)
        Bobomb.unfollow()
        Bobomb.follow(luigi, 300)
        animation.runImageAnimation(
        Bobomb,
        [img`
            . . . . . . . . 5 . . . . . . . 
            ...
            . . . . 4 4 4 4 4 . . . . . . . 
            . . . 4 4 4 4 4 4 4 . . . 5 . . 
            . . 1 4 4 4 1 4 4 4 4 . 5 . 5 . 
            . . 4 1 4 1 4 4 4 4 4 5 . 5 . . 
            . . 4 1 4 1 4 4 4 4 4 5 . 5 . . 
...
forever(function () {
    if (Disable6 == 1) {
        sprites.destroyAllSpritesOfKind(SpriteKind.blue_koopa)
        blue_koopa_health = 0
    }
})
forever(function () {
...
forever(function () {
    if (Fuse >= 6) {
        ...
        [img`
            ...
            .....222222222222222222.......
            .....222222222222222222.......
            ..222224555555555544444422....
            ..222224555555555544444422....
            ..222224555555555544444422....
            .....224455511115555444422....
            .....224455511115555444422....
            .....222444411111111544222....
            .....222444411111111544222....
            .....222244455551155544422....
            .....222244455551155544422....
            .....222244455551155544422....
            .....222244455555544444422....
            .....222244455555544444422....
            .....222244455555544444422....
            .......22222455555444222222...
            .......22222455555444222222...
            ...
            ...2222222222222222222222.....
            ...2222222222222222222222.....
            22222245555555555555444444222.
            22222245555555555555444444222.
            22222245555555555555444444222.
            ...22244455111111555544444222.
            ...22244455111111555544444222.
            ...22244455111111555544444222.
            ...22224444111111111154442222.
            ...22224444111111111154442222.
            ...22222244555555111554444222.
            ...22222244555555111554444222.
            ...22222244555555111554444222.
            ...22222244555555555444444222.
            ...22222244555555555444444222.
            ...22222244555555555444444222.
            ...22222244555555555444444222.
            ......222224455555554422222222
            ......222224455555554422222222
            ......22222444444444222222222.
            .........2244444444422222.....
            .........22222222222..........
            .........22222222222..........
            .........22222222222..........
...
forever(function () {
    if (Luigi_State == -1) {
        enemy_bullet = sprites.createProjectileFromSprite(assets.image`luigi bullet`, enemy_bullet, 0, 50)
        enemy_bullet1 = sprites.createProjectileFromSprite(assets.image`luigi bullet`, enemy_bullet1, 50, 50)
        enemy_bullet2 = sprites.createProjectileFromSprite(assets.image`luigi bullet`, enemy_bullet2, -50, 50)
        enemy_bullet3 = sprites.createProjectileFromSprite(assets.image`luigi bullet`, enemy_bullet3, 0, -50)
    }
})
forever(function () {
    if (Disable3 == 1) {
...
forever(function () {
    if (Luigi_State == -1) {
        projectile = sprites.createProjectileFromSprite(assets.image`mario bullet`, luigi_bullet, 50, 50)
        projectile = sprites.createProjectileFromSprite(assets.image`mario bullet`, luigi_bullet_1, 50, 50)
